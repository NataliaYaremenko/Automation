...
JasmineReporter.prototype.jasmineStarted = util.safeFn(function (options) {
  this.tree.addTotalTestCount(this.getTotalNotDisabledSpecCount());
});

JasmineReporter.prototype.suiteStarted = util.safeFn(function (result) {
...
JasmineReporter.prototype.suiteDone = util.safeFn(function (result) {
 ...
 */
JasmineReporter.prototype.specStarted = util.safeFn(function (result) {
 ...
 * @param {jasmine.Result} result
 */
JasmineReporter.prototype.specDone = util.safeFn(function (result) {
...
JasmineReporter.prototype.jasmineDone = util.safeFn(function () {
