...
/**
 * @typedef {import('../../../../../JavaScriptLanguage/src/helpers/base-test-reporter/intellij-tree.js').Tree} BaseReporterTestsTree
 */
...
class TestTreeBuilder {
   ...
   * @private
   */
  _tree = new Tree(null, process.stdout.write.bind(process.stdout));
   ...
   */
  buildWithReporterError(testFilePath, failureMsg, failureDetails) {
    this._fileNodes.finishLast();
